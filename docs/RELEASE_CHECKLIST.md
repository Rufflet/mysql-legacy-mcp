...
- [ ] Push .github/workflows/publish.yml, then configure npm trusted publishing for it. The workflow is manual and defaults to npm publish --dry-run; a real release requires explicitly setting its publish input to true.
