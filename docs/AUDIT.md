...
On 2026-09-10, authenticated GitHub API access confirmed the personal account Rufflet. The public repository is https://github.com/Rufflet/mysql-legacy-mcp. Package author, repository, homepage, and issues links are populated, and private: true has been removed. `mysql-legacy-mcp@0.2.0` was published to npm the same day (see RELEASE_CHECKLIST.md for the publish and Trusted Publishing setup). On 2026-09-14 the same version was published to the official MCP Registry as `io.github.Rufflet/mysql-legacy-mcp` (see Phase 2 in RELEASE_CHECKLIST.md).
